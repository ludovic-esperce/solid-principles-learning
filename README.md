...
- choisir 1 des principes SOLID et effetuer des recherches
- trouver un exemple de code (en Java, C#, Python ou autre) illustrant chaque principe (vous pourrez, par exemple, présenter du code qui **va à l'encontre** d'un principe SOLID)
- expliquer le principe en utilisant des diagrammes
- présenter l'intérêt de respecter le prinipe
- préparer 1 présentation (maximum 10 minutes) présentant le principe, la présentation pourra comporter :
    - 1 ou plusieurs diagrammes UML et/ou des schémas de principe
    - des exemples de code

**Livrable** :
- un document (markdown ou diaporama) résumant vos recherches, explication et exemples qui sert de support à la présentation (maximum 10 minutes)
